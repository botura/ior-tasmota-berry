...
#undef  SHIFT595_INVERT_OUTPUTS
#define SHIFT595_INVERT_OUTPUTS true            // [SetOption133] Don't invert outputs of 74x595 shift register
#undef  SHIFT595_DEVICE_COUNT
#define SHIFT595_DEVICE_COUNT  2
